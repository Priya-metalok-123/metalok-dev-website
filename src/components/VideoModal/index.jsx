...
export default function VideoModal({ videoSrc, bgUrl, variant }) {
  ...
  const handelClick = () => {
    ...
    setIframeSrc('https://s3.amazonaws.com/thecolosseum.metalok.io/metalok-website/main+final+office+encoder_90mb.mp4 ' );
    setToggle(!toggle);
        // <video  
        //   style={{ maxWidth: "100" }}
        //   autoPlay
        ...
        //   // controls
        //   alt="All the devices" 
        //   setIframeSrc="https://s3.amazonaws.com/thecolosseum.metalok.io/metalok-website/poap-video.mp4"
        // /> 
  };
  const handelClose = () => {
