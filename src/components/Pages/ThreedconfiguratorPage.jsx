...
import ThreedconfigFaq from '../Accordion/threedconfigFaq';
import '../Accordion/shapeStyle.scss';
 

export default function ThreedconfiguratorPage() {
  // const [isLoading, setIsLoading] = useState(true);
  // const handleIframeLoad = () => {
  //   setIsLoading(false); // Set isLoading to false when the iframe is loaded
  // };
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setIsLoading2(false);
    }, 6000); // Delay for the second iframe
  }, []);
  pageTitle('3D Configurator Service');
  ...
  return (
    <>
      ...
      <Div className="container">
        ...
        <div className="">
          <img src="https://s3.amazonaws.com/design.metalok.io/Video/Loading+screen.gif" alt="" />
              ...
              <iframe
                src="https://s3.amazonaws.com/design.metalok.io/Shoe/index.htm"
                height="500px"
                width="100%"
          ...
          <Div className="col-xl-3 col-lg-7 offset-xl-1">
            <SectionHeading title="3D Configurator " subtitle="3D Configurator">
              <Spacing lg="30" md="20" />
              <p className="cs-m0">
                Power your business with immersive visualization of 3D Configurator. We build photorealistic 3D models
                of your products that can be customized and personalized in different colors, materials, sizes, and
                styles as desired by your customers
              </p>
              <Spacing lg="30" md="30" />
      ...
      <Div className="container">
        <SectionHeading title="Our Method " subtitle="" variant="cs-style1 text-center" />
        <Spacing lg="90" md="45" />
        <Div className="row">
      ...
      <Div className="container">
        ...
        <div className="">
          <img src="https://s3.amazonaws.com/design.metalok.io/Video/Loading+screen.gif" alt="" />
                ...
                <iframe
                  src="https://s3.amazonaws.com/design.metalok.io/sofaset/index.htm"
                  height="500px"
                  width="100%"
                  title="3d Configurator"
          ...
          <Div className="col-lg-5 offset-xl-1 col-sm-12">
      ...
      <Div className="container cs-shape_wrap_4">
        <Div className="cs-shape_4 shape_bg-img_thred"></Div>
        <Div className="cs-shape_4 shape_bg-img_thred"></Div>
        <Div className="container">
          <Div className="row">
